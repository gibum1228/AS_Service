...
<body>
	<div id="app" style="padding-top: 30px;">
		...
		<form method="POST">
			...
			<div class="container">
				<b>비밀번호*</b>
				<input type="password" name="pwd" v-model.trim="m.pwd" placeholder="비밀번호" autocomplete="off"
					@change="pswSame" />
			...
			<div class="container">
				<b>이메일*</b>
				<input type="email" name="email" v-model.trim="m.email" placeholder="ID@domain.com"
					@change="emailSame" />

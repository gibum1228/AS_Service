...
<div class="select_top_down">
	...
	<div class="select_middle">
			...
			<tr>
				...
				<td><a class="selected_button" id="button2" value = "button2"  onclick="setColor('button2')"  href="select_com_tablet">태블릿</button></td>
			...
			<!-- LG 14Z980-GAP50ML -->
				<td>
					<div class="card" style="width: 18rem;" style="height: 18rem;">
						<img src="/media/device/ipad.jpg" class="card-img-top" alt="lg그램"
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
     ...
     <button type="submit" class="btn btn-primary"  data-confirm>예약신청완료</button>	
				...
				<td>
					<div class="card" style="width: 18rem;" style="height: 18rem;">
						<img src="/media/device/tab.jpg" class="card-img-top" alt="lg그램"
